...
> = {
  blue: {
    ...
    cardFrom: "hover:from-blue-500/10 dark:hover:from-blue-500/50",
    cardTo: "hover:to-blue-500/5 dark:hover:to-blue-500/10",
    cardShadow: "hover:shadow-[0_8px_32px_-10px_rgba(59,130,246,0.15)] dark:hover:shadow-[0_8px_32px_-10px_rgba(59,130,246,0.3)]",
    cardGlow: "bg-blue-500/5",
    cardGlowHover: "group-hover:bg-blue-500/10",
    cardTitleHover: "group-hover:text-blue-600 dark:group-hover:text-blue-400",
    tocActive: "text-blue-600 dark:text-blue-400",
    tocShadow: "bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.4)] dark:shadow-[0_0_8px_rgba(59,130,246,0.8)]",
    cardBorderHover: "hover:border-blue-500 dark:hover:border-blue-400",
  },
  purple: {
    dot: "bg-purple-500",
    ...
    cardFrom: "hover:from-purple-500/10 dark:hover:from-purple-500/50",
    cardTo: "hover:to-purple-500/5 dark:hover:to-purple-500/10",
    cardShadow: "hover:shadow-[0_8px_32px_-10px_rgba(168,85,247,0.15)] dark:hover:shadow-[0_8px_32px_-10px_rgba(168,85,247,0.3)]",
    cardGlow: "bg-purple-500/5",
    cardGlowHover: "group-hover:bg-purple-500/10",
    cardTitleHover: "group-hover:text-purple-600 dark:group-hover:text-purple-400",
    tocActive: "text-purple-600 dark:text-purple-400",
    tocShadow: "bg-purple-500 shadow-[0_0_8px_rgba(168,85,247,0.4)] dark:shadow-[0_0_8px_rgba(168,85,247,0.8)]",
    cardBorderHover: "hover:border-purple-500 dark:hover:border-purple-400",
  },
  emerald: {
    dot: "bg-emerald-500",
    ...
    cardFrom: "hover:from-emerald-500/10 dark:hover:from-emerald-500/50",
    cardTo: "hover:to-emerald-500/5 dark:hover:to-emerald-500/10",
    cardShadow: "hover:shadow-[0_8px_32px_-10px_rgba(16,185,129,0.15)] dark:hover:shadow-[0_8px_32px_-10px_rgba(16,185,129,0.3)]",
    ...
    tocActive: "text-emerald-600 dark:text-emerald-400",
    tocShadow: "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)] dark:shadow-[0_0_8px_rgba(16,185,129,0.8)]",
    cardBorderHover: "hover:border-emerald-500 dark:hover:border-emerald-400",
  },
};
